...
- Import usageEvents, ratings, skills from @everyskill/db schema tables
- Import sql, eq, count from drizzle-orm
- Import formatRating from @everyskill/db (services)
...
IMPORTANT: Handle null db case - return all zeros if db is null.
  ...
  <verify>
TypeScript compilation passes: `pnpm --filter @everyskill/web exec tsc --noEmit`
  </verify>
  <done>
