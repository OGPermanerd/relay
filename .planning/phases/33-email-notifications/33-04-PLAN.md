...
- At the bottom of the dropdown, add a footer with a Link to "/settings/notifications" labeled "Notification Settings" (small gear icon or text link). This is the only in-app path to the preferences page created in Plan 05.
