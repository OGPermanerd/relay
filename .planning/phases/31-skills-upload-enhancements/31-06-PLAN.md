...
Note: Wave 3 is intentional -- this plan requires both the skill_messages DB layer (Plan 04) and the SimilarityPane UI (Plan 05) to be complete before wiring the messaging flow.
</objective>
...
@.planning/phases/31-skills-upload-enhancements/31-05-SUMMARY.md
</context>
...
<task type="auto">
  ...
  <action>
    ...
    4. Wire into `apps/web/components/skill-upload-form.tsx`:
       ...
       - The `messageTarget` state was prepared in Plan 05. Render:
         ```tsx
         {messageTarget && (
           <MessageAuthorDialog
             skill={messageTarget}
...
<output>
After completion, create `.planning/phases/31-skills-upload-enhancements/31-06-SUMMARY.md`
</output>
