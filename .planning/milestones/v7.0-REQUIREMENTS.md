# Requirements Archive: v7.0 Algorithm & Architecture Rewrite

**Archived:** 2026-02-18
**Status:** ✅ SHIPPED

For current requirements, see `.planning/REQUIREMENTS.md` (deleted after archive — fresh one created for next milestone).
...
- [x] **VIS-01**: Skills support 4 visibility levels: global_approved, tenant, personal, private
- [x] **VIS-02**: Visibility filter (buildVisibilityFilter) enforces all 4 levels correctly
- [x] **VIS-03**: Global approved skills are visible across tenants via updated RLS policy
- [x] **VIS-04**: Author can select visibility level when creating or editing a skill
- [x] **VIS-05**: Only admins can promote skills to global_approved
- [x] **VIS-06**: MCP tools can read and write user search preferences
- [x] **VIS-07**: MCP search applies user preference boosts when authenticated
...
|-------------|-------|--------|
| COMM-01 | Phase 72 | Complete |
| COMM-02 | Phase 73 | Complete |
| COMM-03 | Phase 73 | Complete |
| COMM-04 | Phase 73 | Complete |
| COMM-05 | Phase 72 | Complete |
...
---
*Archived: 2026-02-18 as part of v7.0 milestone completion*
