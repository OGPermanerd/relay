...
import type { OverviewStats, UsageTrendPoint } from "@/lib/analytics-queries";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <StatCard
          ...
          icon={<ClockIcon />}
        />
        <StatCard label="Active Employees" value={stats.activeEmployees} icon={<UsersIcon />} />
        <StatCard label="Skills Deployed" value={stats.skillsDeployed} icon={<CubeIcon />} />
        <StatCard
